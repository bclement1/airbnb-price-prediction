...
Description :
    Using Bagging model to predict price for an AirBnB appartement
                                                                          """
#############################################################################
#############################################################################
#############################################################################
...
for method in FILL_NA_METHOD_List:
    ...
    save_file_path = "../logs/bagging_grid_search/{}/".format(
    ...
    parameters = {
          'base_estimator': [None, SVR(),LinearRegression(), KNeighborsRegressor()],
    ...
    description["Model"] = "Bagging Grid Search"
