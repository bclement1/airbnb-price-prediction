...
Description :
    Using Random Forest model to predict price for an AirBnB appartement
                                                                          """
#############################################################################
#############################################################################
#############################################################################
...
for method in FILL_NA_METHOD_List:
    ...
    save_file_path = "../logs/Random_Forest _grid_search/{}/".format(
    ...
    description["Model"] = "Random Forest Grid Search"
