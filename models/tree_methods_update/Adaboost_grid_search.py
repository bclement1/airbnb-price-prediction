...
Description :
    Using Adaboost model to predict price for an AirBnB appartement
                                                                          """
#############################################################################
#############################################################################
#############################################################################
...
for method in FILL_NA_METHOD_List:
    ...
    save_file_path = "../logs/adaboost_grid_search/{}/".format(
    ...
    parameters = {
        "base_estimator" : [tree.DecisionTreeRegressor(max_depth=i) for i in range(4,11)],
    ...
    description["Model"] = "Adaboost Grid Search"
